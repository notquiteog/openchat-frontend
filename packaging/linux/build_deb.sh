...
Depends: libc6 (>= 2.31), libstdc++6, zlib1g, libgtk-3-0, libsecret-1-0, libx11-6, libxi6, libgstreamer1.0-0, libgstreamer-plugins-base1.0-0, libmpv2, libayatana-appindicator3-1 | libappindicator3-1
