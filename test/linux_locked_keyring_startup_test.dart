...
void main() {
  test(
    'auth startup shows logged-out state when Linux keyring is locked',
    () async {
  ...
  test('login reports locked keyring before continuing', () async {
    ...
    await auth.initialize();
    await auth.login(identifier: 'alice', password: 'password123');
