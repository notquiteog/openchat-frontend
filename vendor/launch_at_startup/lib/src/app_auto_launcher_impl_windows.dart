...
class AppAutoLauncherImplWindows extends AppAutoLauncher {
  ...
  Future<bool> isEnabled() async {
    final value = _regKey.getValue(appName);

    return value is StringValue &&
        value.value == _registryValue &&
        await _isStartupApproved();
  }

  @override
  Future<bool> enable() async {
    _regKey.setValue(appName, RegistryValue.string(_registryValue));
  ...
  Future<bool> _isStartupApproved() async {
    ...
    if (value == null || value is! BinaryValue) {
      return true;
    }
